module {
  ...
  %10 = linalg.matmul ins(%5, %6 : tensor<3x2xf32>, tensor<2x4xf32>) outs(%7 : tensor<3x4xf32>) -> tensor<3x4xf32>
  ...
  %15 = tensor.empty() : tensor<2x4xf32>
  %16 = linalg.add ins(%6, %8 : tensor<2x4xf32>, tensor<2x4xf32>) outs(%15 : tensor<2x4xf32>) -> tensor<2x4xf32>
  %17 = tensor.empty() : tensor<3x4xf32>
  %18 = linalg.matmul ins(%5, %16 : tensor<3x2xf32>, tensor<2x4xf32>) outs(%17 : tensor<3x4xf32>) -> tensor<3x4xf32>
  %19 = tensor.empty() : tensor<2x3xf32>
  %20 = linalg.matmul ins(%1, %3 : tensor<2x4xf32>, tensor<4x3xf32>) outs(%19 : tensor<2x3xf32>) -> tensor<2x3xf32>
  %21 = tensor.empty() : tensor<3x3xf32>
  %22 = linalg.matmul ins(%0, %20 : tensor<3x2xf32>, tensor<2x3xf32>) outs(%21 : tensor<3x3xf32>) -> tensor<3x3xf32>
